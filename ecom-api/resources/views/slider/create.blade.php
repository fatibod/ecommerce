...
@section('dashboard-content')
    ...
    <form action="{{ URL::to('post-slider-form')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control mt-3" id="exampleInputEmail1" name="sliderTitle"aria-describedby="emailHelp" placeholder="Enter name">
        </div>

        <div class="form-group">
            <label for="exampleInputEmail1">Slider message</label>
            <textarea id="postetail" name="sliderMessage"></textarea>
        </div>
        <div class="form-group">
